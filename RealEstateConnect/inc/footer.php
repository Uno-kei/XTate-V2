    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2">
                        <a href="search.php?property_type=1" class="text-white text-decoration-none">Single Family Home</a>
                    </li>
                    <li class="mb-2">
                        <a href="search.php?property_type=2" class="text-white text-decoration-none">Apartment</a>
                    </li>
                    <li class="mb-2">
                        <a href="search.php?property_type=3" class="text-white text-decoration-none">Condo</a>
                    </li>
                    <li class="mb-2">
                        <a href="search.php?property_type=4" class="text-white text-decoration-none">Townhouse</a>
                    </li>
                    <li class="mb-2">
                        <a href="search.php?property_type=5" class="text-white text-decoration-none">Land</a>
                    </li>
                    <li class="mb-2">
                        <a href="search.php?property_type=6" class="text-white text-decoration-none">Commercial</a>
                    </li>
                </ul>
            </div>
